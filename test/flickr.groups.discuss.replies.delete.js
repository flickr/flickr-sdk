...
describe('flickr.groups.discuss.replies.delete', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.groups.discuss.replies.delete({ api_key: '_', group_id: '_', topic_id: '_', reply_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.groups.discuss.replies.delete', { api_key: '_', group_id: '_', topic_id: '_', reply_id: '_' });
		});
	});
