...
describe('flickr.groups.discuss.replies.add', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.groups.discuss.replies.add({ api_key: '_', group_id: '_', topic_id: '_', message: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.groups.discuss.replies.add', { api_key: '_', group_id: '_', topic_id: '_', message: '_' });
		});
	});
