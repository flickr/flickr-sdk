...
describe('flickr.photosets.setPrimaryPhoto', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.photosets.setPrimaryPhoto({ api_key: '_', photoset_id: '_', photo_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.photosets.setPrimaryPhoto', { api_key: '_', photoset_id: '_', photo_id: '_' });
		});
	});
