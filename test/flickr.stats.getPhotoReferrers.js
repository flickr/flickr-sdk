...
describe('flickr.stats.getPhotoReferrers', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.stats.getPhotoReferrers({ api_key: '_', date: '_', domain: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.stats.getPhotoReferrers', { api_key: '_', date: '_', domain: '_' });
		});
	});
