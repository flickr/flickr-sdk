...
describe('flickr.photosets.reorderPhotos', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.photosets.reorderPhotos({ api_key: '_', photoset_id: '_', photo_ids: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.photosets.reorderPhotos', { api_key: '_', photoset_id: '_', photo_ids: '_' });
		});
	});
