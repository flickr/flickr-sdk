...
describe('flickr.places.getTopPlacesList', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.places.getTopPlacesList({ api_key: '_', place_type_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.places.getTopPlacesList', { api_key: '_', place_type_id: '_' });
		});
	});
