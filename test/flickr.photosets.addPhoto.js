...
describe('flickr.photosets.addPhoto', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.photosets.addPhoto({ api_key: '_', photoset_id: '_', photo_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.photosets.addPhoto', { api_key: '_', photoset_id: '_', photo_id: '_' });
		});
	});
