...
describe('flickr.photosets.getInfo', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.photosets.getInfo({ api_key: '_', photoset_id: '_', user_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.photosets.getInfo', { api_key: '_', photoset_id: '_', user_id: '_' });
		});
	});
