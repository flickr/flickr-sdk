...
describe('flickr.photos.getContactsPublicPhotos', function () {
	...
	it('calls the correct API method', function () {
		...
		return flickr.photos.getContactsPublicPhotos({ api_key: '_', user_id: '_' })
		.then(function () {
			sinon.assert.calledOnce(request);
			sinon.assert.calledWith(request, 'flickr.photos.getContactsPublicPhotos', { api_key: '_', user_id: '_' });
		});
	});
